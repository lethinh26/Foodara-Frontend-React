...
export const mockVouchers: Voucher[] = [
  {
    ...
    isStackable: false,
    isActive: true,
    conditions: ['Don toi thieu 100.000d', 'Giam toi da 50.000d'],
    isCollected: true,
    isUsed: false,
    collectedAt: '2025-03-14T09:00:00Z',
    potentialDiscount: 0,
  },
  {
    id: 'v-002',
    ...
    description: 'Ap dung cho don tu 50k',
    type: 'free_ship',
    scope: 'platform',
    storeId: null,
    discountValue: 25000,
    ...
    isStackable: true,
    isActive: true,
    conditions: ['Don toi thieu 50.000d'],
    isCollected: true,
    isUsed: false,
    collectedAt: '2025-03-14T10:00:00Z',
    potentialDiscount: 0,
  },
  {
    id: 'v-003',
    code: 'PHO20K',
    title: 'Giam 20k quan Pho',
    description: 'Giam 20k cho don tu 80k tai quan Pho',
    type: 'fixed',
    scope: 'store',
    storeId: 'rest-001',
    discountValue: 20000,
    ...
    isStackable: false,
    isActive: true,
    conditions: ['Chi ap dung tai quan Pho', 'Don toi thieu 80.000d'],
    isCollected: false,
    isUsed: false,
    collectedAt: null,
    potentialDiscount: 0,
  },
  {
    id: 'v-004',
    code: 'NEWUSER50',
    title: 'Giam 50% cho khach moi',
    description: 'Danh cho don hang dau tien',
    type: 'percentage',
    scope: 'platform',
    storeId: null,
    discountValue: 50,
    ...
    isStackable: false,
    isActive: true,
    conditions: ['Chi ap dung cho don dau tien'],
    isCollected: true,
    isUsed: false,
    collectedAt: '2025-03-01T00:00:00Z',
    potentialDiscount: 0,
  },
];
